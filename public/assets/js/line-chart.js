...
function creategraph(){
    ...
    graphdata = graphdata.filter(function( element ) {
        return element !== undefined;
     });
     graphdata1 = graphdata1.filter(function( element ) {
        return element !== undefined;
     });
     
    document.getElementById('latestsmoke').innerHTML=this.graphdata[4];
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            labels: this.graphdata1.map(function(data){
...
function createtempgraph(){
    ...
    graphtempdata = graphtempdata.filter(function( element ) {
        return element !== undefined;
     });
     graphtempdata1 = graphtempdata1.filter(function( element ) {
        return element !== undefined;
     });
    document.getElementById('latesttemp').innerHTML=this.graphtempdata[5];
    ...
    var chart = new Chart(ctx, {
        ...
        // The data for our dataset
        data: {
            labels: this.graphtempdata1.map(function(data){
                var theDate = new Date(data * 1000);
                dateString = theDate.toGMTString();
                return dateString;
            }),
...
/* Moisture */
function createmoistgraph(){
  
    
    var ctx = document.getElementById("coin_sales3").getContext('2d');

    document.getElementById('latestmoisture').innerHTML=this.graphmoistdata[5];
    ...
    var chart = new Chart(ctx, {
        ...
        // The data for our dataset
        data: {
            labels: this.graphmoistdata1.map(function(data){
                var theDate = new Date(data * 1000);
                dateString = theDate.toGMTString();
                return dateString;
            }),
